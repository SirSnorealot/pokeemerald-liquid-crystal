...
static void Task_Truck1(u8 taskId)
{
    ...
    SetObjectEventSpritePosByLocalIdAndMap(0,      gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup, BOX1_X_OFFSET - cameraXpan, BOX1_Y_OFFSET + yBox1); // TODO(LC): was LOCALID_TRUCK_BOX_TOP (removed with Hoenn maps)
    yBox2 = GetTruckBoxYMovement(tTimer) * 2;
    SetObjectEventSpritePosByLocalIdAndMap(0, gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup, BOX2_X_OFFSET - cameraXpan, BOX2_Y_OFFSET + yBox2); // TODO(LC): was LOCALID_TRUCK_BOX_BOTTOM_L (removed with Hoenn maps)
    yBox3 = GetTruckBoxYMovement(tTimer) * 4;
    SetObjectEventSpritePosByLocalIdAndMap(0, gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup, BOX3_X_OFFSET - cameraXpan, BOX3_Y_OFFSET + yBox3); // TODO(LC): was LOCALID_TRUCK_BOX_BOTTOM_R (removed with Hoenn maps)
...
static void Task_Truck3(u8 taskId)
{
   ...
   else
   {
       ...
       cameraYpan = 0;
       SetCameraPanning(cameraXpan, cameraYpan);
       SetObjectEventSpritePosByLocalIdAndMap(0,      gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup, BOX1_X_OFFSET - cameraXpan, BOX1_Y_OFFSET + cameraYpan); // TODO(LC): was LOCALID_TRUCK_BOX_TOP (removed with Hoenn maps)
       SetObjectEventSpritePosByLocalIdAndMap(0, gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup, BOX2_X_OFFSET - cameraXpan, BOX2_Y_OFFSET + cameraYpan); // TODO(LC): was LOCALID_TRUCK_BOX_BOTTOM_L (removed with Hoenn maps)
       SetObjectEventSpritePosByLocalIdAndMap(0, gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup, BOX3_X_OFFSET - cameraXpan, BOX3_Y_OFFSET + cameraYpan); // TODO(LC): was LOCALID_TRUCK_BOX_BOTTOM_R (removed with Hoenn maps)
   }
}
...
void EndTruckSequence(u8 taskId)
{
    ...
    {
        SetObjectEventSpritePosByLocalIdAndMap(0,      gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup, BOX1_X_OFFSET, BOX1_Y_OFFSET); // TODO(LC): was LOCALID_TRUCK_BOX_TOP (removed with Hoenn maps)
        SetObjectEventSpritePosByLocalIdAndMap(0, gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup, BOX2_X_OFFSET, BOX2_Y_OFFSET); // TODO(LC): was LOCALID_TRUCK_BOX_BOTTOM_L (removed with Hoenn maps)
        SetObjectEventSpritePosByLocalIdAndMap(0, gSaveBlock1Ptr->location.mapNum, gSaveBlock1Ptr->location.mapGroup, BOX3_X_OFFSET, BOX3_Y_OFFSET); // TODO(LC): was LOCALID_TRUCK_BOX_BOTTOM_R (removed with Hoenn maps)
    }
}
