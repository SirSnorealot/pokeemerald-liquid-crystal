...
static bool32 IsValidLocationForVsSeeker(void)
{
    ...
    {
        { MAP_GROUP(MAP_RUINS_OF_ALPH_PUZZLE_ROOM_B),           MAP_NUM(MAP_RUINS_OF_ALPH_PUZZLE_ROOM_B) },
        ...
        { MAP_GROUP(MAP_OUTSKIRT_ISLAND), MAP_NUM(MAP_OUTSKIRT_ISLAND) },
        ...
        { MAP_GROUP(MAP_VIOLET_CITY_GYM),         MAP_NUM(MAP_VIOLET_CITY_GYM) },
