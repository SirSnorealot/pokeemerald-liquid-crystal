...
static const struct {
    ...
    },
    {
        ...
        .level = 15,
        .location = MAP_NUM(MAP_ROUTE43),
    },
    {
        .species = SPECIES_SEEDOT,
        .moves = {MOVE_HARDEN, MOVE_GROWTH, MOVE_NATURE_POWER, MOVE_LEECH_SEED},
        .level = 13,
        .location = MAP_NUM(MAP_ROUTE34),
    },
    {
        .species = SPECIES_SEEDOT,
...
static bool8 ShouldApplyPokeNewsEffect(u8 newsKind)
{
    ...
    case POKENEWS_SLATEPORT:
        if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_AZALEA_TOWN)
         && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAP_AZALEA_TOWN)
...
u8 CheckForPlayersHouseNews(void)
{
    ...
    if (gSaveBlock1Ptr->location.mapGroup != MAP_GROUP(MAP_NEW_BARK_TOWN_PLAYERS_HOUSE_1F))
        return PLAYERS_HOUSE_TV_NONE;

    // Check if not in player's house (dependent on gender)
    if (gSaveBlock2Ptr->playerGender == MALE)
    {
        if (gSaveBlock1Ptr->location.mapNum != MAP_NUM(MAP_NEW_BARK_TOWN_PLAYERS_HOUSE_1F))
            return PLAYERS_HOUSE_TV_NONE;
    }
    else
    {
...
static void DoTVShowTodaysRivalTrainer(void)
{
    ...
    case 0:
        ...
        case MAPSEC_DYNAMIC:
            ...
            {
            // TODO(LC): SS Tidal maps removed with Hoenn maps
